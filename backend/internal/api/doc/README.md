...
- **Model**: Contains database-specific models generated by `root/backend/pkg/dbmodels` (e.g., messages.go).
- **Repository**: Implements the repository interfaces defined in the domain layer using specific frameworks (e.g., SQLBoiler for database operations).
